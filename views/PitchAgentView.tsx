  ...
  useEffect(() => {
    ...
    const flow = async () => {
          ...
          <div className="space-y-4">
            ...
            <div className="grid gap-3">
              {[
                ...
                <div key={i} className="bg-[#151515] hover:bg-[#1a1a1a] p-4 rounded-xl border border-neutral-800 transition-all cursor-pointer group shadow-sm">
      ...
      setMessages(prev => [...prev, {
        ...
        content: (
          <div className="space-y-4">
            <p>Excellent choice! Combining those creates a powerful experience. I've generated your pitch deck structure.</p>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4 bg-[#151515] p-4 rounded-xl border border-neutral-800 border-l-4 border-l-[#FFD700]">
               <div className="col-span-full mb-2">
                  <div className="flex items-center text-white font-bold text-sm mb-1"><CheckCircle2 size={16} className="text-[#FFD700] mr-2"/> Pitch Structure Ready</div>
               </div>
              <DemoTooltip>
                <motion.button 
      ...
      <div className="flex-1 flex flex-col lg:flex-row gap-6 min-h-0">
        ...
        >
           ...
           <div className="flex-1 flex flex-col p-4 items-center">
              ...
              {/* History List */}
              <div className="flex-1 w-full space-y-3 overflow-y-auto overflow-x-visible no-scrollbar flex flex-col items-center px-1">
